...
sed -i 's/destemail = '.*'/destemail = saudiconnect24@gmail.com/g' /etc/fail2ban/jail.local
...
<div class="jumbotron">
<h1 class="display-3 text-center fn-color">Saudi connect</h1>
<h4 class="text-center fn-color">Follow Us</h4>
<p class="text-center">https://web.facebook.com/alaminbd17</p>
</div>
</div>
</body>
</html>
